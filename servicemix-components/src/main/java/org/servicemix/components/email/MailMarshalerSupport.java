...
public abstract class MailMarshalerSupport extends MarshalerSupport {
    ...
    private Expression to = new PropertyExpression("org.servicemix.email.to");
    private Expression cc = new PropertyExpression("org.servicemix.email.cc");
    private Expression bcc = new PropertyExpression("org.servicemix.email.bcc");
    private Expression from = new PropertyExpression("org.servicemix.email.from", "noone@servicemix.org");
    private Expression text = new PropertyExpression("org.servicemix.email.text");
    private Expression subject = new PropertyExpression("org.servicemix.email.subject", "Message from ServiceMix");
    private Expression replyTo = new PropertyExpression("org.servicemix.email.replyTo");
    private Expression sentDate = new PropertyExpression("org.servicemix.email.sentDate");
