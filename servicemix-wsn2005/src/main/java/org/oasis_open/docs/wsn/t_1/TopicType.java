...
import org.apache.servicemix.wsn.jaxb2.QNameListAdapter;
    ...
    extends ExtensibleDocumented
{
    ...
    @XmlElement(name = "MessagePattern", namespace = "http://docs.oasis-open.org/wsn/t-1")
    protected QueryExpressionType messagePattern;
    @XmlElement(name = "Topic", namespace = "http://docs.oasis-open.org/wsn/t-1", required = true, type = TopicType.class)
    ...
    @XmlAttribute
    @XmlJavaTypeAdapter(QNameListAdapter.class)
