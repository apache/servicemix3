...
public abstract class SoapEndpoint extends Endpoint {
    ...
    protected Map<String, Node> wsdls = new HashMap<String, Node>();
    protected Binding<?> binding;
    
    public SoapEndpoint() {
        Policy wsAddr = new WsAddressingPolicy();
        policies = Collections.singletonList(wsAddr);
    }
     ...
     */
    public Map<String, Node> getWsdls() {
        return wsdls;
    }
