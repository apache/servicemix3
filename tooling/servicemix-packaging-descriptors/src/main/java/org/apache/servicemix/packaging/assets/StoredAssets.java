...
public class StoredAssets {
	...
	private List<ArtifactReference> artifactReference = new ArrayList<ArtifactReference>();
	...
	public List<ArtifactReference> getArtifactReference() {
	...
	public void setArtifactReference(List<ArtifactReference> artifactReference) {
