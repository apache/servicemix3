 ...
 * @version $Revision$
 */
public class AssemblyDescriptorTask extends JbiTask {
    private static final Log log = LogFactory.getLog(AssemblyDescriptorTask.class);
    ...
    public void execute() throws BuildException {
        ...
        try {
            ...
            log.error("Caught an exception getting assembly descriptor", e);
